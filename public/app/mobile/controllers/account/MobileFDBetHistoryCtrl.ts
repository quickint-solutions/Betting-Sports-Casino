module intranet.home {
    export interface IMobileFDBetHistoryScope extends intranet.common.IScopeBase {
        search: any;
        promiseItem: any;
        memberList: any[];
        member: any;
    ...
    export class MobileFDBetHistoryCtrl extends intranet.common.ControllerBase<IMobileFDBetHistoryScope>
        implements intranet.common.init.IInit {
        constructor($scope: IMobileFDBetHistoryScope,
