module intranet.mobile {
    export interface IBkingLiveGamesHighlightScope extends intranet.common.IBetScopeBase {
        highlights: any[];
    ...
    export class BkingLiveGamesHighlightCtrl extends intranet.common.BetControllerBase<IBkingLiveGamesHighlightScope>
        implements intranet.common.init.IInit {
        constructor($scope: IBkingLiveGamesHighlightScope,
        ...
        // place bet
        public placeBet(m: any, side: any, runnerId: any, price: any, runnerName: string, percentage: any = 100, sectionId: any): void {
            var model = new common.helpers.BetModal(m, side, runnerId, price, runnerName);
