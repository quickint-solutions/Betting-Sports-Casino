module intranet.master {
    ...
    export interface IPositionScope extends intranet.common.IScopeBase {
        pinnedMarkets: any[];
    ...
    export class PositionCtrl extends intranet.common.ControllerBase<IPositionScope>
        implements common.init.IInit {
        constructor($scope: IPositionScope,
        ...
        private getUserPosition(pin: any): void {
            ...
            var model = { MarketId: pin.market.id, isPT: pin.market.includePT  };
    ...
    angular.module('intranet.master').controller('positionCtrl', PositionCtrl);
}