module intranet.master {
    export interface IFDGameReportScope extends intranet.common.IScopeBase {
        search: any;
        userList: any[];
        promiseItem: any;
        currentUserType: any;
    ...
    export class FDGameReportCtrl extends intranet.common.ControllerBase<IFDGameReportScope>
        implements intranet.common.init.IInit {
        constructor($scope: IFDGameReportScope,
