module intranet.admin {
    ...
    export interface ISAB2CTransactionsScope extends intranet.common.IScopeBase {
        search: any;
        canILoad: boolean;
        reportType: any;
    }

    export class SAB2CTransactionCtrl extends intranet.common.ControllerBase<ISAB2CTransactionsScope>
        implements common.init.IInit {
        constructor($scope: ISAB2CTransactionsScope,
