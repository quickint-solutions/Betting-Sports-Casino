...
module intranet.admin {
    ...
    export interface ISAB2CSummaryScope extends intranet.common.IScopeBase {
        search: { fromdate: any, todate: any };
        canILoad: any;
        gridItems: any[];
    }

    export class SAB2CSummaryCtrl extends intranet.common.ControllerBase<ISAB2CSummaryScope>
        implements common.init.IInit {
        constructor($scope: ISAB2CSummaryScope,
        ...
        private showTransactions(item: any, dwType: any) {
            ...
            var url = this.$state.href('admin.b2ctransactions', { searchId: id, reporttype: 1 });
        ...
        private showBonusTransactions(item: any, dwType: any) {
            ...
            this.localStorageHelper.set('b2c_search_' + id, model);
            var url = this.$state.href('admin.b2ctransactions', { searchId: id, reporttype: 2 });
            this.$window.open(url, '_blank');
        }
    ...
    angular.module('intranet.admin').controller('sAB2CSummaryCtrl', SAB2CSummaryCtrl);
}