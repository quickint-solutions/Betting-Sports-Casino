module intranet.admin {
    ...
    export interface ISAFullPositionScope extends intranet.common.IScopeBase {
        p: any;
        market: any;
        positions: any;
    ...
    export class SAFullPositionCtrl extends intranet.common.ControllerBase<ISAFullPositionScope>
        implements common.init.IInit {
        constructor($scope: ISAFullPositionScope,
