module intranet.admin {
    export interface ISAPositionTreeScope extends intranet.common.IScopeBase {
        sportTreeList: any[];
        breadcrumb: any[];
    ...
    export class SAPositionTreeCtrl extends intranet.common.ControllerBase<ISAPositionTreeScope>
        implements intranet.common.init.IInit {
        constructor($scope: ISAPositionTreeScope,
