module intranet.admin {
    export interface ISAMarketReportScope extends intranet.common.IScopeBase {
        search: any;
        eventTypeList: any[];
        userList: any[];
        promiseItem: any;
    ...
    export class SAMarketReportCtrl extends intranet.common.ControllerBase<ISAMarketReportScope>
        implements intranet.common.init.IInit {
        constructor($scope: ISAMarketReportScope,
