module intranet.admin {
    export interface ISADownlineSummaryScope extends intranet.common.IScopeBase {
        search: any;
        canILoad: boolean;
        gridItems: any[];
    ...
    export class SADownlineSummaryCtrl extends intranet.common.ControllerBase<ISADownlineSummaryScope>
        implements intranet.common.init.IInit {
        constructor($scope: ISADownlineSummaryScope,
            private $state: any,
