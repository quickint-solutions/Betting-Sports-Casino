...
module intranet.home {
    export interface IMyProfileScope extends intranet.common.IScopeBase {
        user: any;
        timezone: any;
        languageList: any[];
        eventTypes: any[];
    ...
    export class MyProfileCtrl extends intranet.common.ControllerBase<IMyProfileScope>
        implements intranet.common.init.IInit {
        constructor($scope: IMyProfileScope,
        ...
        public loadInitialData(): void {
            if (this.$stateParams.memberid) {
                this.$scope.fromMember = true; this.getUserDataById();
            }
            else {
                this.getUserData();
                this.getLanguages();
        ...
        private getBetConfig(data: any = undefined): void {
            this.commonDataService.getEventTypes()
                .then((data: any) => {
                    ...
                    if (!data) {
                        ...
                        promise.success((response: common.messaging.IResponse<any>) => {
                            if (response.success) {
                                angular.forEach(this.$scope.eventTypes, (e: any) => {
                                    angular.forEach(response.data.betConfigs, (d: any) => {
                        ...
                        angular.forEach(this.$scope.eventTypes, (e: any) => {
                            angular.forEach(this.$scope.user.betConfigs, (d: any) => {
                                if (e.id == d.eventTypeId) {
                                    e.betDelay = d.betDelay;
                                    e.maxBet = d.maxBet;
                                    e.maxExposure = d.maxExposure;
