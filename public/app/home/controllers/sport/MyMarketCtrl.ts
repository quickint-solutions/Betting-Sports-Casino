module intranet.home {
    export interface IMyMarketScope extends intranet.common.IBetScopeBase {
        markets: any[];
    ...
    export class MyMarketCtrl extends intranet.common.BetControllerBase<IMyMarketScope>
        implements intranet.common.init.IInit {
        constructor($scope: IMyMarketScope,
        ...
        private loadMyMarkets(): void {
            ...
            this.marketOddsService.getMyMarkets()
                .success((response: common.messaging.IResponse<any>) => {
                    if (response.success) {
                        //this.$scope.markets = response.data;
