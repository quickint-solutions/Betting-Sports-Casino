...
(function (intranet) {
    var home;
    (function (home) {
        class LiveGamesHighlightCtrl extends intranet.common.BetControllerBase {
            ...
            placeBet(m, side, runnerId, price, runnerName, percentage = 100, sectionId, tdId = 0, islast = false) {
                if (m.marketStatus == intranet.common.enums.MarketStatus.OPEN) {
                    ...
                    if (m.gameType == intranet.common.enums.GameType.AndarBahar
                        || m.gameType == intranet.common.enums.GameType.Up7Down
                        || m.gameType == intranet.common.enums.GameType.DragonTiger) {
