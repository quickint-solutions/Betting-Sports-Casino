...
(function (intranet) {
    var master;
    (function (master) {
        class PositionCtrl extends intranet.common.ControllerBase {
            ...
            openFullPositionView(event, eventid, marketid) {
                if (event) {
                    event.stopPropagation();
                }
