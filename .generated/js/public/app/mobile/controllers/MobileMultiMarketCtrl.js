...
(function (intranet) {
    var mobile;
    (function (mobile) {
        class MobileMultiMarketCtrl extends intranet.common.BetControllerBase {
            constructor($scope, $rootScope, $compile, $filter, WSSocketService, marketOddsService, placeBetDataService, $timeout, localStorageHelper, toasterService, commonDataService, settings, betService) {
                super($scope);
        ...
        mobile.MobileMultiMarketCtrl = MobileMultiMarketCtrl;
...
//# sourceMappingURL=MobileMultiMarketCtrl.js.map