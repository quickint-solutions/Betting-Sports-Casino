...
(function (intranet) {
    var mobile;
    (function (mobile) {
        class MobileMarketCtrl extends intranet.common.BetControllerBase {
            constructor($scope, $stateParams, $rootScope, $state, $compile, $filter, WSSocketService, marketService, commentaryService, marketOddsService, placeBetDataService, $timeout, localStorageHelper, toasterService, commonDataService, modalService, settings, exposureService, betService) {
                super($scope);
