...
(function (intranet) {
    ...
    (function (mobile) {
        var account;
        (function (account) {
            class MobileMyProfileCtrl extends intranet.common.ControllerBase {
                constructor($scope, commonDataService, toasterService, translationService, modalService, userService, paymentService, localStorageHelper, languageService, $timeout, settingService, $sce, settings) {
                    super($scope);
                ...
                getBetConfig() {
                    this.commonDataService.getEventTypes()
                        ...
                        this.commonDataService.getUserBetConfig().then((data) => {
            ...
            account.MobileMyProfileCtrl = MobileMyProfileCtrl;
...
//# sourceMappingURL=MobileMyProfileCtrl.js.map