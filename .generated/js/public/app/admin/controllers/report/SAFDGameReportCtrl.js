...
(function (intranet) {
    var admin;
    (function (admin) {
        class SAFDGameReportCtrl extends intranet.common.ControllerBase {
            constructor($scope, $stateParams, $q, $state, $filter, ExportFactory, userService, commonDataService, fdService) {
                super($scope);
        ...
        admin.SAFDGameReportCtrl = SAFDGameReportCtrl;
        angular.module('intranet.admin').controller('sAFDGameReportCtrl', SAFDGameReportCtrl);
    })(admin = intranet.admin || (intranet.admin = {}));
})(intranet || (intranet = {}));
//# sourceMappingURL=SAFDGameReportCtrl.js.map