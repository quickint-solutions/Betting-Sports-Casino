...
(function (intranet) {
    var admin;
    (function (admin) {
        class SAFDLiveBetsCtrl extends intranet.common.ControllerBase {
            constructor($scope, localStorageHelper, eventTypeService, eventService, marketService, modalService, userService, $filter, $q, commonDataService, $timeout, fdService, settings) {
                super($scope);
